...
pub fn join(lhs: Value, rhs: Value) -> StrResult<Value> {
    ...
    Ok(match (lhs, rhs) {
        (a, None) => a,
        (None, b) => b,
        (Symbol(a), Symbol(b)) => Str(format_str!("{a}{b}").into()),
        (Str(a), Str(b)) => Str((a.into_text() + b.into_text()).into()),
        (Str(a), Symbol(b)) => Str(format_str!("{a}{b}").into()),
        (Symbol(a), Str(b)) => Str(format_str!("{a}{b}").into()),
        (Bytes(a), Bytes(b)) => Bytes(a + b),
        (Content(a), Content(b)) => Content(a + b),
        (Content(a), Symbol(b)) => Content(a + SymbolElem::packed(b.get())),
        (Content(a), Str(b)) => Content(a + TextElem::packed(b.text().clone())),
        (Str(a), Content(b)) => Content(TextElem::packed(a.text().clone()) + b),
...
pub fn mul(lhs: Value, rhs: Value) -> HintedStrResult<Value> {
    ...
    Ok(match (lhs, rhs) {
        ...
        (Str(a), Int(b)) => Str(a.repeat(Value::Int(b).cast()?)?.into()),
        (Int(a), Str(b)) => Str(b.repeat(Value::Int(a).cast()?)?.into()),
